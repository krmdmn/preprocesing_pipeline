...
t1_list = sorted(glob.glob('/home/kerimduman/Downloads/monai/the last version - sripped and registered/*/*T1.nii.gz'))
t2_list = sorted(glob.glob('/home/kerimduman/Downloads/monai/the last version - sripped and registered/*/*T2.nii.gz'))
t1ce_list = sorted(glob.glob('/home/kerimduman/Downloads/monai/the last version - sripped and registered/*/*T1ce.nii'))
flair_list = sorted(glob.glob('/home/kerimduman/Downloads/monai/the last version - sripped and registered/*/*FLAIR.nii.gz'))
mask_list = sorted(glob.glob('/home/kerimduman/Downloads/monai/the last version - sripped and registered/*/*mask.nii'))
...
for root, dirs, files in os.walk("/home/kerimduman/Downloads/monai/the last version - sripped and registered/", True):
   break
...
if True:
    ...
    offset=0
    for k in range(int(len(mask_list))):
    # for k in range(5):
